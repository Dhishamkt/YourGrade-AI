      ...
      <div style={{
        ...
        <div className="flex flex-col md:flex-row">
          ...
          <div className="flex flex-col justify-center p-8 md:p-10" style={{flex: 1}}>
            <h1 style={{color: "#0F2854", fontSize: "26px", fontWeight: "bold", marginBottom: "8px"}}>Create Account</h1>
            <p style={{color: "#888", fontSize: "14px", marginBottom: "28px"}}>Register to get started</p>
